  ...
  return (
    <>
      <div className="max-w-md mx-auto my-20  border-0 shadow-2xl rounded-2xl p-6 sm:p-10 ">
        ...
        <h2 className="block text-center text-orange-500">Sign up for Swiggy</h2>
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" disabled={loading} className="block bg-orange-500 hover:bg-orange-600 cursor-pointer w-full h-10 rounded-2xl mt-2.5">
            {loading ? "Signing Up..." : "Sign Up"}
          </button>
        </form>
        <p className="block text-center">Already have an account? <a href="/login" className="text-blue-500">Login</a></p>
      </div>
    </>
  );
}
